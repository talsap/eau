...
class Page01(wx.Panel):
     ...
     def __init__(self, parent, id):
         ...
         self.texto01 = wx.StaticText(self, -1, 'DADOS DA COLETA:',(20,50), (120,-1), wx.ALIGN_LEFT)
         self.texto02 = wx.StaticText(self, -1, 'Data da coleta', (300,53), (75,-1), wx.ALIGN_LEFT)
         self.date = wx.TextCtrl(self, -1, dadosIniciais[10], (380,50),(85,-1), wx.TE_READONLY | wx.TE_LEFT)
         self.texto03 = wx.StaticText(self, -1, 'Local',(130,85), (35,-1), wx.ALIGN_LEFT)
         self.localColeta = wx.TextCtrl(self, -1, dadosIniciais[7], (165,80),(300,-1), wx.TE_READONLY | wx.TE_RIGHT)
         self.texto04 = wx.StaticText(self, -1, 'Operador',(156,113), (55,-1), wx.ALIGN_LEFT)
         self.operador = wx.TextCtrl(self, -1, dadosIniciais[8], (213,110), (252,-1), wx.TE_READONLY | wx.TE_RIGHT)
         self.texto05 = wx.StaticText(self, -1, 'Profundidade (m)',(295,145), (100,-1), wx.ALIGN_LEFT)
         self.profundidade = wx.TextCtrl(self, -1, dadosIniciais[9], (395,140),(70,-1), wx.TE_READONLY | wx.TE_RIGHT)
         self.texto06 = wx.StaticText(self, -1, 'DADOS DO ANEL:',(20,170), (100,-1), wx.ALIGN_LEFT)
         self.tipoAnel = wx.TextCtrl(self, -1, dadosIniciais[0], (265,185),(200,-1), wx.TE_READONLY | wx.TE_LEFT)
         self.texto07 = wx.StaticText(self, -1, 'Tipo de Anel',(190,190), (75,-1), wx.ALIGN_LEFT)
         self.diametro = wx.TextCtrl(self, -1, dadosIniciais[1], (395,215),(70,-1), wx.TE_READONLY | wx.TE_RIGHT)
         self.texto08 = wx.StaticText(self, -1, 'Diametro Interno (mm)',(265,220), (130,-1), wx.ALIGN_LEFT)
         self.alturaAnel = wx.TextCtrl(self, -1, dadosIniciais[2], (176,215),(70,-1), wx.TE_READONLY | wx.TE_RIGHT)
         self.texto09 = wx.StaticText(self, -1, 'Altura (mm)',(105,220), (70,-1), wx.ALIGN_LEFT)
         self.massaAnel = wx.TextCtrl(self, -1, dadosIniciais[3], (395,245),(70,-1), wx.TE_READONLY | wx.TE_RIGHT)
         self.texto10 = wx.StaticText(self, -1, 'Massa do Anel (g)',(293,250), (100,-1), wx.ALIGN_LEFT)
         self.texto11 = wx.StaticText(self, -1, 'DADOS DO CORPO-DE-PROVA:',(20,280), (170,-1), wx.ALIGN_LEFT)
         self.alturaCP = wx.TextCtrl(self, -1, dadosIniciais[4], (395,290),(70,-1), wx.TE_READONLY | wx.TE_RIGHT)
         self.texto12 = wx.StaticText(self, -1, 'Altura do corpo-de-prova (mm)',(220,295), (170,-1), wx.ALIGN_LEFT)
         self.massaCP = wx.TextCtrl(self, -1, dadosIniciais[6], (395,320),(70,-1), wx.TE_READONLY | wx.TE_RIGHT)
         self.texto13 = wx.StaticText(self, -1, 'Massa do corpo-de-prova (g)',(233,325), (155,-1), wx.ALIGN_LEFT)
         self.massaEspecifica = wx.TextCtrl(self, -1, dadosIniciais[5], (395,350),(70,-1),  wx.TE_READONLY | wx.TE_RIGHT)
         self.texto14 = wx.StaticText(self, -1, 'Massa específica dos grãos de solo (g/cm³)',(161,355), (230,-1), wx.ALIGN_LEFT)
         self.texto15 = wx.StaticText(self, -1, 'DADOS DO TEOR DE UMIDADE INICIAL:',(20,385), (230,-1), wx.ALIGN_LEFT)
         self.cap01 = wx.TextCtrl(self, -1, caps[0], (235,405),(70,-1), style = wx.TE_READONLY | wx.TE_LEFT)
         self.cap02 = wx.TextCtrl(self, -1, caps[1], (315,405),(70,-1), style = wx.TE_READONLY | wx.TE_LEFT)
         self.cap03 = wx.TextCtrl(self, -1, caps[2], (395,405),(70,-1), style = wx.TE_READONLY | wx.TE_LEFT)
         self.texto16 = wx.StaticText(self, -1, 'Capsulas',(180,408), (50,-1), wx.ALIGN_LEFT)
         self.massaUmida01 = wx.TextCtrl(self, -1, massaUmida[0], (235,435),(70,-1), wx.TE_READONLY | wx.TE_RIGHT)
         self.massaUmida02 = wx.TextCtrl(self, -1, massaUmida[1], (315,435),(70,-1), wx.TE_READONLY | wx.TE_RIGHT)
         self.massaUmida03 = wx.TextCtrl(self, -1, massaUmida[2], (395,435),(70,-1), wx.TE_READONLY | wx.TE_RIGHT)
         self.texto17 = wx.StaticText(self, -1, 'Massa Úmida (g)',(138,438), (90,-1), wx.ALIGN_LEFT)
         self.massaSeca01 = wx.TextCtrl(self, -1, massaSeca[0], (235,465),(70,-1), wx.TE_READONLY | wx.TE_RIGHT)
         self.massaSeca02 = wx.TextCtrl(self, -1, massaSeca[1], (315,465),(70,-1), wx.TE_READONLY | wx.TE_RIGHT)
         self.massaSeca03 = wx.TextCtrl(self, -1, massaSeca[2], (395,465),(70,-1), wx.TE_READONLY | wx.TE_RIGHT)
         self.texto18 = wx.StaticText(self, -1, 'Massa Seca (g)',(148,468), (80,-1), wx.ALIGN_LEFT)
         self.Editar = wx.Button(self, -1, 'Editar', (188, 504), (112,-1), wx.ALIGN_LEFT)
     ...
     def editarDados(self, event):
         ...
         self.Editar.Destroy()
         self.date = wx.adv.DatePickerCtrl(self, -1, data, (380,50), size=wx.DefaultSize, style = wx.adv.DP_SHOWCENTURY | wx.adv.DP_DROPDOWN, validator=wx.DefaultValidator, name="datectrl")
         self.localColeta = wx.TextCtrl(self, -1, dadosIniciais[7], (165,80),(300,-1), wx.TE_RIGHT)
         self.localColeta.SetMaxLength(40)
         self.operador = wx.TextCtrl(self, -1, dadosIniciais[8], (213,110), (252,-1), wx.TE_RIGHT)
         self.operador.SetMaxLength(40)
         self.profundidade = wx.TextCtrl(self, -1, dadosIniciais[9], (395,140),(70,-1), wx.TE_RIGHT)
         self.tipoAnel = wx.ComboBox(self, -1, dadosIniciais[0], (265,185),(200,-1), choices = ('Anel fixo', 'Anel flutuante'))
         self.diametro = wx.TextCtrl(self, -1, dadosIniciais[1], (395,215),(70,-1), wx.TE_RIGHT)
         self.alturaAnel = wx.TextCtrl(self, -1, dadosIniciais[2], (176,215),(70,-1), wx.TE_RIGHT)
         self.massaAnel = wx.TextCtrl(self, -1, dadosIniciais[3], (395,245),(70,-1), wx.TE_RIGHT)
         self.alturaCP = wx.TextCtrl(self, -1, dadosIniciais[4], (395,290),(70,-1), wx.TE_RIGHT)
         self.massaCP = wx.TextCtrl(self, -1, dadosIniciais[6], (395,320),(70,-1), wx.TE_RIGHT)
         self.massaEspecifica = wx.TextCtrl(self, -1, dadosIniciais[5], (395,350),(70,-1), wx.TE_RIGHT)
         self.capsulaComboBox01 = wx.ComboBox(self, -1, caps[0], (235,405),(70,-1), capCadastradas)
         self.capsulaComboBox02 = wx.ComboBox(self, -1, caps[1], (315,405),(70,-1), capCadastradas)
         self.capsulaComboBox03 = wx.ComboBox(self, -1, caps[2], (395,405),(70,-1), capCadastradas)
         self.massaUmida01 = wx.TextCtrl(self, -1, massaUmida[0], (235,435),(70,-1), wx.TE_RIGHT)
         self.massaUmida02 = wx.TextCtrl(self, -1, massaUmida[1], (315,435),(70,-1), wx.TE_RIGHT)
         self.massaUmida03 = wx.TextCtrl(self, -1, massaUmida[2], (395,435),(70,-1), wx.TE_RIGHT)
         self.massaSeca01 = wx.TextCtrl(self, -1, massaSeca[0], (235,465),(70,-1), wx.TE_RIGHT)
         self.massaSeca02 = wx.TextCtrl(self, -1, massaSeca[1], (315,465),(70,-1), wx.TE_RIGHT)
         self.massaSeca03 = wx.TextCtrl(self, -1, massaSeca[2], (395,465),(70,-1), wx.TE_RIGHT)
         self.Salvar = wx.Button(self, -1, 'Salvar', (188, 504), (112,-1), wx.ALIGN_LEFT)
            ...
            if d>=0 and f>0 and g>0 and h>0 and i>0 and j>0 and k>0 and o>0 and p>0 and q>0 and r>0 and s>0 and t>0:
                if f!= '' and g!= '' and h!= '' and i!= '' and j!= '' and k!= '' and o!= '' and p!= '' and q!= '' and r!= '' and  s!= '' and t!= '' and l!= ''  and m!= '' and n!= '':
                    if l in capCadastradas and m in capCadastradas and n in capCadastradas and l!= m and l!= n and m!= n:
                        ...
                        bancodedados.UpdateDadosEnsaio(id, e, f, g, h, massaC, i, k, dateCol, b, c, d, l, m, n, r, s, t, o, p, q)
...
class Page02(wx.Panel):
     def __init__(self, parent, id):
         ...
         try:
             ...
             print("TELA QUANDO NÂO TEM DADOS DE ESTÁGIO NO BANCO") #Fazer tela com um botão de coletar dados somente (COLOCAR ESSES DADOS TAMBÉM NA FUNÇAO exc)
     ...
     def exc(self, event):
         ...
         if result == wx.ID_YES:
             ...
             try:
                 ...
                 print("Erro ao Atualizar a ListaEstagios ou ComboBoxEstagios ou PressaoAplicadaEstagios")
                 #Fazer tela com um botão de coletar dados somente
